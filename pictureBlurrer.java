...
public class pictureBlurrer{
     ...
     * it lets me sum the remaining pixels around the pixel at (row, col). One problem that arises is that an undesired
     * black border would form around the image, to combat this I predetermined the amount of pixels counted to 9 and
     * by utilizing the same try-catch whenever a pixel would be skipped for being out of bounds the number of pixels
     ...
     * 
     * 
     * This method returns two numbers in the form of an array, the first number is the actual sum and the second is the
